...
async function run() {
  try {
    ...
    /* 
    - don't show secure links to those who should not see links
    ...
    */
    ...
    app.get('/admin-stats', verifyJWT, verifyAdmin, async(req, res) =>{
      ...
      // best way to get sum of the price field is is to use group and sum operator
      /* 
    ...
    1. load all payments
    2. for eact payments, get the menuItems array
    3. for each item in the menuItems array get the menuItem from the menu collection
    4. put them in an array: allOrderedItems
    5. separate allOrderedItems by category using filter
    6. now get the quantity by n using length: pizzas.length
